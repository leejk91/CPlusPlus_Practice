...
QT_MOC_LITERAL(1, 11, 16), // "TestDialogClosed"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 3), // "msg"
QT_MOC_LITERAL(4, 33, 23) // "on_pushButton_2_clicked"

    },
    "TestDialog\0TestDialogClosed\0\0msg\0"
...
void TestDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->TestDialogClosed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (TestDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TestDialog::TestDialogClosed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TestDialog::TestDialogClosed(QString _t1)
{
