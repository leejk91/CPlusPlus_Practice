...
"}"));
    ...
    {
        RepairTestKTCDialog->setWindowTitle(QApplication::translate("RepairTestKTCDialog", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("RepairTestKTCDialog", "KTC TEST", Q_NULLPTR));
        pushButton_3->setText(QApplication::translate("RepairTestKTCDialog", "Close", Q_NULLPTR));
        pushButton->setText(QApplication::translate("RepairTestKTCDialog", "Clear", Q_NULLPTR));
    } // retranslateUi
